...
def build_model(num_dev, seq_len, num_cls):
    ...
    x = Dense(d_model, activation=None, name='sig_projection')(inp_sig)
    ...
    x = GlobalAveragePooling1D(name='sig_global_avg')(x)
...
def main():
    ...
    plt.tight_layout()
    save_figure('confusion_matrixSSSS.png')
    ...
    plt.tight_layout()
    save_figure('tsne_featuresSSSS.png')
